...
Para activar los formularios y sus notificaciones se deben ejecutar las migraciones y desplegar la Edge Function según [`docs/supabase.md`](docs/supabase.md).
